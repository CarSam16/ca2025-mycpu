      ...
      Seq(
        ...
        InstructionsTypeL.lb -> MuxLookup(mem_address_index, Cat(Fill(24, data(31)), data(31, 24)))(
          Seq(
    		...
    		3.U -> Cat(Fill(24, bytes(3)(7)), bytes(3))
          )
        ),
        ...
        InstructionsTypeL.lh -> Mux(
          ...
          Cat(Fill(16, half(15)), half), // halfword 0-15
          Cat(Fill(16, half(15)), half)  // upper halfword 16-31
        ),
        ...
        InstructionsTypeL.lhu -> Mux(
          mem_address_index === 0.U,
          Cat(Fill(16, 0.U), half),     // halfword 0-15
          Cat(Fill(16, 0.U), half)      // upper halfword 16-31
        ),
